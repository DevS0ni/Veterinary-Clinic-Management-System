...
// Checking which is the next slot that is available and return the index
int next_slotAvailable(struct Appointment* app, int maxAppointments);

// Checking if appointment is valid
